...
public class SecurityConfiguration {
    ...
    private List<String> publicUrlMethodGet = List.of(
            ...
            "/api/v1/sites/**",
            "/api/v1/auth/**");
    private List<String> publicUrlMethodPost = List.of(
            "/api/v1/auth/**",
            "/api/v1/tickets/cart");
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequest -> authorizeRequest
                                .requestMatchers(HttpMethod.GET, publicUrlMethodGet.toArray(String[]::new)).permitAll()
                                .requestMatchers(HttpMethod.POST, publicUrlMethodPost.toArray(String[]::new)).permitAll()
